...
const txController = __importStar(require("../controllers/transaction.controller"));
...
router.post('/voice', rateLimiter_1.voiceRateLimiter, upload.single('audio'), txController.createVoiceTransaction);
